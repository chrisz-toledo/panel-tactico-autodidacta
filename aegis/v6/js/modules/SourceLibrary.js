 ...
 * AEGIS v6.0
 * 
 * Importa datos desde biblioteca.js (ES6 module), proporciona búsqueda,
 * filtrado, recomendaciones basadas en energía.
 */

import { BIBLIOTECA_SOURCES, BIBLIOTECA_METADATA } from '../data/biblioteca.js';

class SourceLibrary {
  constructor() {
    this.sources = BIBLIOTECA_SOURCES || [];
    this.metadata = BIBLIOTECA_METADATA || {};
    this.loaded = true; // Datos ya cargados vía import
    
    // Construir índices inmediatamente
  ...
  /**
   * Inicialización (ahora síncrona gracias a ES6 imports)
   */
  async load() {
    // Los datos ya están cargados vía import ES6
    return true;
  }
